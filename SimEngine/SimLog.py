...
LOG_RPL_JOIN_DAG                  = {u'type': u'rpl.join_dag','keys': [u'_mote_id',u'_joined_dag']}
LOG_RPL_SWITCH_DAG                  = {u'type': u'rpl.switch_dag','keys': [u'_mote_id',u'_switched_to_dag']}
...
LOG_DEPLOY_COORDINATES            = {u'type': u'conn.deploy',               u'keys': [u'_mote_id', u'_coordinates']}
